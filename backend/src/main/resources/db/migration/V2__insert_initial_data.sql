...
-- Países
INSERT IGNORE INTO
    countries (id, name, iso_code, image_url)
VALUES (
        1,
        'Brasil',
        'BR',
...
VALUES (
        1,
        'A língua principal falada neste país é o Espanhol?',
        'CULTURA',
        '/images/maps/idiomas.png'
    ),
    (
        2,
        'A Cordilheira dos Andes passa por este país?',
        'GEOGRAFIA',
        '/images/maps/andes.png'
    ),
    (
        3,
        'Este país tem saída para o mar (litoral)?',
        'GEOGRAFIA',
        '/images/maps/litoral.png'
    ),
    (
        4,
        'A bandeira deste país possui a cor Verde?',
        'BANDEIRA',
        NULL
    ),
    (
        5,
        'Este país é banhado pelo Oceano Pacífico?',
        'GEOGRAFIA',
        '/images/maps/oceanos.png'
    ),
    (
        6,
        'Este país faz fronteira com o Brasil?',
        'GEOGRAFIA',
        '/images/maps/fronteiras-br.png'
    ),
    (
        7,
        'A moeda oficial deste lugar é o Euro?',
        'ECONOMIA',
        '/images/maps/moedas.png'
    ),
    (
        8,
        'Este país tem mais de 40 milhões de habitantes?',
        'POPULACAO',
        NULL
    ),
    (
        9,
        'A bandeira deste país tem a cor Vermelha?',
        'BANDEIRA',
        NULL
    ),
    (
        10,
        'A Linha do Equador corta este país?',
        'GEOGRAFIA',
        '/images/maps/equador.png'
    ),
    (
        11,
        'A bandeira deste país possui um símbolo de "Sol"?',
        'BANDEIRA',
        '/images/maps/sol-bandeira.png'
    ),
    (
        12,
        'A seleção de futebol masculina deste país já venceu uma Copa do Mundo?',
        'CULTURA',
        NULL
    ),
    (
        13,
        'Este país é banhado pelo Mar do Caribe (parte norte)?',
        'GEOGRAFIA',
        '/images/maps/caribe.png'
    ),
    (
        14,
